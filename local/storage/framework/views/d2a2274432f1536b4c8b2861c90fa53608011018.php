...
<body>
  ...
  <table style="width: 100%">
    ...
    <td width="250px"><font size="2" style="color:red;font-weight: bold; "">Nro: <?php echo $datos[0]->idVenta; ?></font></td>
      ...
      <td><img src="<?php echo e(asset('images/logo.png')); ?>" width="150px" height="70px"></td>
    </tr> 
  </table>
...
<?php $total=0; ?>
  <table border="2" cellspacing="3" cellpadding="5" style="width: 100%">
    ...
    <tbody>   
    <?php foreach($datoventa as $res): ?>
    <tr align="center">
      <td><?php echo e($res->num); ?></td>

      <td><?php echo e($res->fechaPago); ?></td>

      <td><?php echo e($res->cuota); ?></td>

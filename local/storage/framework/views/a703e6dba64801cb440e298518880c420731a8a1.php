...
<?php endif; ?>
 ...
 <?php echo $__env->make('perfilobjeto.modal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

    <font size="6">Agregar Objeto <?php echo $perfil[0]->nombre  ?> Al  Perfil</font>
             <?php echo Form::open(['route'=>'PerfilObjeto.store', 'method'=>'POST']); ?>
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	...
	<div class="table-responsive">
		...
		<?php foreach($perfilObjeto as $po): ?>
		<tr style="text-align: center">
		<td><?php echo e($po->nombre); ?> 
		...
		<td><button data-toggle='modal' data-target='#myModal' onclick="CargarModal(<?php echo e($po->id); ?>)" class="btn btn-primary" title="Modificar"><i class="fa fa-pencil" aria-hidden="true" ></i></button>
        ...
        <script src="<?php echo e(asset('js/PerfilObjeto.js')); ?>"></script> 

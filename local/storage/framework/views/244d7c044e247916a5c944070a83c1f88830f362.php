...
<?php echo $__env->make('venta.DetalleCuota', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo Form::open(['route' => 'PagoVenta/search', 'method' => 'post', 'novalidate', 'class' => 'form-inline']); ?>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <font size="6">PAGOS DE VENTAS</font>
        </div>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered table-condensed table-hover">
                ...
                switch ($lis->estado_venta) {
                    case 'c':?> 
                    <?php echo link_to_route('PlanPago.show', $title='PAGAR', $parameters=$lis->id, $attributes=['class'=>'btn-sm btn-success']); ?>

                    <?php //{!!link_to_route('Pago.show', $title='LISTA PAGOS', $parameters=$lis->id, $attributes=['class'=>'btn-sm btn-info'])!!} ?>
                    <a class="btn-sm btn-info" data-toggle="modal" style="cursor: pointer;" data-target="#DetalleCuota" onclick="CargarCuotas(<?php echo e($lis->id); ?>)">DETALLE</a>        
                <?php   break;                
                    case 'p':?>   
                    <a class="btn-sm btn-info" data-toggle="modal" style="cursor: pointer;" data-target="#DetalleCuota" onclick="CargarCuotas(<?php echo e($lis->id); ?>)">DETALLE</a>         
                <?php   break;
...
<?php echo Html::script('js/cuotas.js'); ?>

    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">      
        ...
        <h3 style="font-weight: bold">DEUDAS POR PAGAR</h3>
            <table class="table table-striped table-bordered table-condensed table-hover">
                ...
                <td><CENTER><?php echo e($deb->fechaLimite); ?></CENTER></td>
                ...
                <!--td><CENTER><?php echo e($deb->monto); ?></CENTER></td-->
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">      
            <table class="table table-striped table-bordered table-condensed table-hover">
                ...
                <td><CENTER><?php echo e($pag->fechaLimite); ?></CENTER></td>                
                <td><CENTER><?php echo e($pag->monto); ?></CENTER></td>

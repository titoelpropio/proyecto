...
<html>
    <head>
       ...
       <!-- <meta name="viewport" content="width=500, initial-scale=1"> -->
              <!-- Bootstrap 3.3.5 -->
  <?php echo Html::style('css/bootstrap/bootstrap.css'); ?>

        <!-- Font Awesome -->
        <?php echo Html::style('css/font-awesome.min.css'); ?>

        <!-- Theme style -->
        <?php echo Html::style('css/plugins/AdminLTE.min.css'); ?>

        <!-- AdminLTE Skins. Choose a skin from the css/skins
             folder instead of downloading all of them to reduce the load. -->
        <?php echo Html::style('css/plugins/_all-skins.min.css'); ?>
        ...
        <link rel="shortcut icon" href="<?php echo e(asset('images/sinfondo.png')); ?>">

        <link rel="apple-touch-icon" href="<?php echo e(asset('images/sinfondo.png')); ?>">
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper"> 
            ...
            <header class="main-header" >
                ...
                <!-- Logo -->
                <a href="<?php echo URL::to('index'); ?>" class="logo">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <small class=""><?php echo Session::get('nombre')." ".Session::get('apellido') ;?></small>
                                         <img src="<?php echo e(asset('images/logout.png')); ?>" class="user-image" alt="User Image">
                                </a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-footer">
                                        ...
                                        <div class="pull-right">
                                            ...
                                            <a href="<?php echo URL::to('logout'); ?>" ><button class="btn btn-danger">CERRAR SESION</button></a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
                    ...
                    <?php
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="<?php echo URL::to('PreReserva'); ?>"><i class="fa fa-building-o" aria-hidden="true"></i></i>PRE-RESERVAR LOTE</a></li>
                                <li><a href="<?php echo URL::to('seccion1/1'); ?>"><i class="fa fa-building-o" aria-hidden="true"></i></i>Mapa</a></li>

                                <!-- <li><a href="<?php echo URL::to('cliente'); ?>"><i class="fa fa-user"></i> Mapa</a></li> -->
                                <li><a href="<?php echo URL::to('ControlPreReserva'); ?>"><i class="fa fa-circle-o"></i>Pre-Reservas Activas</a></li>
                                <?php
                        ...
                        if (count($verficar) != 0) {
                            ?>
                                     ...
                                     <li><a href="<?php echo URL::to('ListaEmpleado'); ?>"><i class="fa fa-circle-o"></i> Gestionar Vendedor</a></li>
<?php } ?>
...
<?php } ?>
                  ...
                  <?php
                        ...
                        <li class="treeview">
                            ...
                            <ul  class="treeview-menu">
                                <li><a href="<?php echo URL::to('Lote'); ?>"><i class="fa fa-tasks"></i>Gestionar Lotes</a></li>
                             ...
                             <i class="fa fa-cogs" aria-hidden="true"></i>
                              ...
                              <i class="fa fa-angle-left pull-right"></i>
                               ...
                               <ul  class="treeview-menu">
                                ...
                                <li><a href="<?php echo URL::to('Proyecto'); ?>"><i class="fa fa-line-chart" aria-hidden="true"></i>PROYECTO</a></li>

                                <li><a href="<?php echo URL::to('Categoria'); ?>"><i class="fa fa-list-ol" aria-hidden="true"></i> CATEGORIA</a></li>

                                <li><a href="<?php echo URL::to('Precio'); ?>"><i class="fa fa-usd" aria-hidden="true"></i> PRECIO</a></li>
                                  <li><a href="<?php echo URL::to('Meses'); ?>"><i class="fa fa-calendar" aria-hidden="true"></i>Meses</a></li>
                              
                                  <li><a href="<?php echo URL::to('CuotaMinima'); ?>"><i  class="fa fa-percent" aria-hidden="true"></i>Cuota Minima</a></li>

                                  <li><a href="<?php echo URL::to('DescuentoVenta'); ?>"><i  class="fa fa-percent" aria-hidden="true"></i>Descuento en Venta</a></li>
                               <li><a href="<?php echo URL::to('PorcentajeDevolucionReserva'); ?>">% Devolucion RESERVA</a></li>

                               <li><a href="<?php echo URL::to('TipoCambio'); ?>"><i class="fa fa-usd" aria-hidden="true"></i>Tipo de Cambio</a></li>
                        ...
                        if (count($verficar) != 0) {
                            ...
                            <li class="treeview">
                                ...
                                <ul  id="gestiones" class="treeview-menu">
                                    <li><a href="<?php echo URL::to('Empleado'); ?>"><i class="fa fa-circle-o"></i> Gestionar Empleado</a></li>

                                    <li><a href="<?php echo URL::to('Cargo'); ?>"><i class="fa fa-circle-o"></i> Gestionar Cargo</a></li>
                                    <li><a href="<?php echo URL::to('Turno'); ?>"> <i class="fa fa-circle-o"></i>Gestionar Turno</a></li>
...
<?php } ?>
                        ...
                        if (count($verficar) != 0) {
                            ...
                            <li class="treeview">
                                ...
                                <ul  id="gestiones" class="treeview-menu">
                                    <li><a href="<?php echo URL::to('Perfil'); ?>"><i class="fa fa-circle-o"></i>Gestionar Perfil</a></li>
                                    <li><a href="<?php echo URL::to('Objeto'); ?>"><i class="fa fa-circle-o"></i> Gestionar Objeto</a></li>
                                    <li><a href="<?php echo URL::to('Modulo'); ?>"><i class="fa fa-circle-o"></i>Gestionar  Modulo</a></li>
...
<?php } ?>
 <?php
                        ...
                        <li class="treeview">
                            ...
                            <ul  id="gestiones" class="treeview-menu">
                                <li><a href="<?php echo URL::to('Empresa'); ?>"><i class="fa fa-circle-o"></i>Gestionar Empresa</a></li>
                                <li><a href="<?php echo URL::to('Banco'); ?>"><i class="fa fa-circle-o"></i>Gestionar Bancos</a></li>
                            </ul>
                        </li>
                            <li class="treeview">
                            <a href="#">
                            ...
                            <ul  id="gestiones" class="treeview-menu">
                                <li><a href="<?php echo URL::to('ReporteVenta'); ?>"><i class="fa fa-circle-o"></i>REPORTE VENTAS</a></li>
                                <li><a href="<?php echo URL::to('ReporteReserva'); ?>"><i class="fa fa-circle-o"></i>REPORTE RESERVA</a></li>
                            </ul>
                        </li>
<?php } ?>
        ...
        <?php echo Html::script('js/plugins/toastr.min.js'); ?>

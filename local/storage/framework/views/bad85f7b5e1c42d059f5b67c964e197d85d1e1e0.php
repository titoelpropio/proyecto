...
<div class="row">	
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 pull-right">    
         ...
         <?php echo Form::open(['route'=>'PreReserva.store', 'method'=>'POST' , 'enctype'=>'multipart/form-data','onKeypress'=>'if(event.keyCode == 13) event.returnValue = false;']); ?> 
        ...
        <!--div class=" col-lg-3 col-md-3 col-sm-3 col-xs-12 ">
            ...
            @<?php foreach ($vendedor as $key => $value): ?>
                <option value="<?php echo e($value->id); ?>"><?php echo e($value->codigo); ?></option>                
            <?php endforeach ?>
            </select>
        </div-->   
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      ...
      <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" id="div_crear_2">
            <div class="form-group">
                <?php echo Form::label('genero','Genero:'); ?> <br>
            ...
            <div class="form-group">
                ...
                <?php echo Form::text('nit',0,['class'=>'form-control ','placeholder'=>'NIT','onkeypress'=>'return bloqueo_de_punto(event)']); ?>

            </div>    
            <div class="pull-right">
                <?php echo Form::submit('RESERVAR',['class'=>'btn btn-primary','id'=>'btn_registrar','onclick'=>'btn_esconder()']); ?>

                <a href="<?php echo URL::to('PreReserva'); ?>" class="btn btn-danger">CANCELAR</a>
            </div>                                                                                                             
      </div> 
    </div>
...
<?php echo Html::script('js/pre_reserva.js'); ?>

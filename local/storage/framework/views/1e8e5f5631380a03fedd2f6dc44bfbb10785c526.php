...
<div class="row">   
    ...
    <?php echo Form::open(['class'=>'form-group','route'=>'Venta.index', 'method'=>'GET']); ?>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <?php echo Form::submit('Buscar',['class'=>'btn btn-primary','id'=>'btn_registrar']); ?>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="table-responsive">
            <table class="table table-striped table-bordered table-condensed table-hover">
                        ...
                        <?php foreach($Lote as $Lot): ?>
                        <TR>    
                        <td><center><?php echo e($Lot->nroLote); ?></center></td>
                        <td><center><?php echo e($Lot->superficie.' '); ?>m<sup>2</sup></center></td>

                        <td><center><?php echo e($Lot->manzano); ?></center></td>
                        <td><center><?php echo e($Lot->categoria); ?></center></td>
                        <td><center><?php echo e(($Lot->precio*$Lot->superficie)-((($Lot->precio*$Lot->superficie)*$Lot->descuento)/100).' '); ?>$us</center></td>
                        <td><center><?php echo e($Lot->precio*$Lot->superficie.' '); ?>$us</center></td>
                       
                        <td><center>
                        <a href="<?php echo URL::to('VentaLote'); ?><?php echo "/".$Lot->id ?>" class="btn btn-success">Vender</a>
                        </center></td>
                        </TR>
                        <?php endforeach; ?> 
            </table>

...
<span style="color: white"><?php echo e(Session::get('message-error')); ?></span>  
</div>
...
<div class="form">
  <div class="thumbnail"><img src="<?php echo e(asset('images/logo.png')); ?>"/></div>
...
<video id="video" autoplay="autoplay" loop="loop" poster="<?php echo e(asset('images/logo.png')); ?>" controls muted>
  <source src="<?php echo e(asset('video/presentacion.mp4')); ?>" type="video/mp4"/>
</video>

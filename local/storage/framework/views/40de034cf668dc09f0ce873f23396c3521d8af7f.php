<div class="modal fade" id="ModalReserva" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" >
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <?php echo Form::open(['route'=>'Reserva.store', 'method'=>'POST' , 'enctype'=>'multipart/form-data','onKeypress'=>'if(event.keyCode == 13) event.returnValue = false;','onsubmit'=>'javascript: return validar()']); ?>   
       ...
       <div class="form-group" style="display: block;" id="divEfectivo">
        <div class="form-group">
            <?php echo Form::label('monto','Monto Efectivo:'); ?>
       ...
       <div class="form-group" style="display: none" id="divBanco">       
          ...
          <?php echo Form::label('cuenta','Nro De Cuenta:'); ?>
          ...
          <?php echo Form::label('montoBanco','Monto Banco:'); ?>
      ...
      <div class="modal-footer">
            <?php echo Form::submit('RESERVAR',['class'=>'btn btn-primary pull-right','id'=>'btn_reservar']); ?>

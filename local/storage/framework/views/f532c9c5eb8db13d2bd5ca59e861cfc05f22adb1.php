...
<?php echo $__env->make('venta.modal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<h3 style="font-weight: bold">FORMULARIO DE VENTA</h3>
<div class="panel panel-success" style="text-transform: uppercase;">
<div class="panel-heading">
  <?php echo Form::open(['route'=>'Venta.store', 'method'=>'POST','onKeypress'=>'if(event.keyCode == 13) event.returnValue = false;']); ?>
       ...
       <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <input type="hidden" name="CuotaMinima" value=<?php echo $cuotaMinima[0]->porcentaje; ?>>
          ...
          <input type="hidden" name="idCliente" value="0">
                <?php echo Form::text('ci',$ci,['id'=>'ci','class'=>'form-control ','placeholder'=>'NUMERO DE CARNET','onchange'=>'BuscarCliente()']); ?>
...
<input type="number" onchange="CompletarPago(this,2)" name="montoEfectivo" placeholder="Monto Efectivo"  class="form-control">
  ...
  <div class="panel-footer">
    ...
    <?php echo Form::submit('VENDER',['class'=>'btn btn-primary','id'=>'btn_registrar']); ?>


<a  class="btn btn-danger " href="<?php echo URL::to('Venta'); ?>">CANCELAR</a>
...
<?php echo Html::script('js/venta2.js'); ?>
